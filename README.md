...
- `kind: service` — a runnable application (how to build and execute an app), with `native` and `docker` runtime blocks. A repo may have zero, one, or many; services never define the repo set.
